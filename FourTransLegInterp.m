function [qxzint, XINT, ZINT, ZLINT] = FourTransLegInterp(REFS, DS, RAY, qxz, NXI, NZI, xint, zint)

%{
Interpolates the 2D field qxz by applying Fourier transform in the
...
This method works for fields that were solved using the Fourier transform
derivative in the horizontal and Legendre P. derivative in the vertical.
Fields that DO NOT conform to the Fourier transform will show errors
when using this method. (i.e. background fields should NOT be interpolated
this way).
%}

%% Interpolate to a regular grid using Fourier and Legendre transforms

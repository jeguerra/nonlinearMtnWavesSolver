...
def computeTopographyOnGrid(REFS, opt):
       ...
       DDX_CS, DDX2A_BC = derv.computeCubicSplineDerivativeMatrix(xh, True, False, 0.0)
       DDX_QS, DDX4A_QS = derv.computeQuinticSplineDerivativeMatrix(xh, True, False, DDX_CS)
